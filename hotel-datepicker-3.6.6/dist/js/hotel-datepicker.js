...
var HotelDatepicker = function HotelDatepicker(input, options) {
	...
	this.i18n = opts.i18n || {
		...
		'error-more': 'Het datumbereik mag niet langer zijn dan 1 nacht',
		'error-more-plural': 'Datumbereik mag niet meer zijn dan %d nachten',
		'error-less': 'Periode mag niet minder dan 1 nacht zijn %d nachten',
		'error-less-plural': 'Het datumbereik mag niet minder zijn dan',
		'info-more': 'Selecteer een periode van minimaal 1 nacht',
		'info-more-plural': 'Selecteer een datumbereik van ten minste %d nachten',
